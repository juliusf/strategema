...
SOURCES=src/main.c src/util.c src/interconnect.c src/cpu.c src/gfx.c src/timer.c 3rdparty/minifb/MacMiniFB.m 3rdparty/minifb/OSXWindow.m 3rdparty/minifb/OSXWindowFrameView.m
OBJECTS=$(SOURCES:.c=.o)
